...
from third_part.face3d.options.inference_options import InferenceOptions
from third_part.face3d.models import create_model
...
def get_data_path(root, keypoint_root):
    ...
    for filename in filenames:
        ...
        keypoint_filenames.append(os.path.join(keypoint_root, name + ".txt"))
...
if __name__ == "__main__":
    ...
    for image_name, keypoint_name in tqdm(zip(image_names, keypoint_names)):
        ...
        np.savetxt("{}/{}_3dmm_coeff.txt".format(opt.output_dir, name), predicted["coeff_3dmm"].reshape(-1))
