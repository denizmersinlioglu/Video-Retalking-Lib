...
from third_part.GPEN.face_model.gpen_model import FullGenerator


class FaceGAN(object):
    def __init__(
        self, base_dir="./", size=512, model=None, channel_multiplier=2, narrow=1, is_norm=True, device="cuda"
    ):
