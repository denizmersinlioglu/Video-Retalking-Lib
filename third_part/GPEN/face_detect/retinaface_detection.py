...
import numpy as np
from third_part.GPEN.face_detect.data import cfg_re50
...
import cv2
from third_part.GPEN.face_detect.facemodels.retinaface import RetinaFace
from third_part.GPEN.face_detect.utils.box_utils import decode, decode_landm
import time
...
class RetinaFaceDetection(object):
    ...
    def detect_tensor(
        self, img, resize=1, confidence_threshold=0.9, nms_threshold=0.4, top_k=5000, keep_top_k=750, save_image=False
    ):
        im_height, im_width = img.shape[-2:]
